...
init_image = Image.open("assets/myface/Koushik-K19-05-b.png").convert("RGB")
...
prompt = "Egyptian pharaoh, extremely detailed, photo-realistic, high quality, (extremely detailed eyes face and hands)"
